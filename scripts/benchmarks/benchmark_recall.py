...
ap.add_argument("--force_rebuild", required=False, metavar="FORCE_REBUILD", type=str.lower, default="false", choices=["0", "true", "false", "0", "1", "y", "n", "yes", "no", None], help="Whether to rebuild model.")
ap.add_argument("--use_local_lib", required=False, metavar="USE_LOCAL_LIB", type=str.lower, default="false", choices=["0", "true", "false", "0", "1", "y", "n", "yes", "no", None], help="Whether to rebuild model.")
